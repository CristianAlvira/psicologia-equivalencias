...
export class SeleccionEstudianteController {
  constructor(private readonly seleccionEstudianteService: SeleccionEstudianteService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateSeleccionEstudianteDto: UpdateSeleccionEstudianteDto) {
    return this.seleccionEstudianteService.update(+id, updateSeleccionEstudianteDto);
  }
